...
timber.productPage = function (options) {
  ...
  if (variant) {
    ...
    if (variant.available) {
      ...
      $addToCartText.html("添加到購物車");
      
      $quantityElements.show();
    } else {
      $addToCart.addClass('disabled').prop('disabled', true);
      $addToCartText.html("售完待補貨");
...
(function($) {
  ...
  ------------------------------------------------------- */
    ...
    var mobileToggle = $('#mobile-toggle'),
        mobileMenu = $('.sub-menu-mobile'),
        searchMobileButton = $('#search-button-mobile'),
    ...
    searchMobileButton.click(function() {  
      ...
      if ( mobileNav.hasClass('focused') ) {
          mobileNav.removeClass('focused');
      };              
  	});

    var desktopToggle = $('#desktop-toggle'),
        desktopMenu = $('.sub-menu-desktop'),
        desktopNav = $('.desktop-nav'); 

    desktopToggle.hover(function() {
        $(this).children('.sub-menu-desktop').stop(true, false, true).fadeToggle(300);
      	if ( desktopNav.hasClass('focused') ) {
          	desktopNav.removeClass('focused');
      	};
    });  
  	...
  	function contentSwitcher(settings) {
        var settings = {
          contentClass: '.quote-content',
          navigationId: '#quotesnav'
        };

        $(settings.contentClass).not('#page1').hide();
