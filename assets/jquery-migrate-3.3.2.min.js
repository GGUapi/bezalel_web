...
function(t) {
    ...
    s.migrateWarnings && n.console.log("JQMIGRATE: Migrate plugin loaded multiple times")/*,n.console.log("JQMIGRATE: Migrate is installed"+(s.migrateMute?"":" with logging active")+", version "+s.migrateVersion)*/
    );
    var r = {};
    function u(e) {
        var t = n.console;
